...
<body>
    ...
    <main class="site-content">
        <!--=========== Breadcrumb Start =========-->
        <section class="breadcrumb-wrapper" data-bg-image="./images/banner/New/About.jpeg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="col-xl-7 col-lg-12">
                        <div class="about-content-one">
                            ...
                            <div class="tj-about-button d-flex">
                                <a class="tj-primary-btn btn" href="about-us.php">
        ...
        <section class="tj-about-section "  style="padding-top:50px;">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-7 col-lg-12">
                        <div class="about-content-one">
