...
<body>
   ...
   <!-- END HEADER -->
    ...
    <main class="site-content ">
        <!--=========== Breadcrumb Start =========-->
        <section class="breadcrumb-wrapper" data-bg-image="images/banner/New/contactus.jpeg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-6">
                        <div class="contact-left-content">
                            <div class="tj-sec-heading-two">
                                <span class="sub-title"><b> Powering a Brighter Future Together</b></span>
                                <h2 class="title">Let's Make the Connection
                                    <!-- Let’s Make
                                    <span>Some Change</span> -->
                                </h2>
                                <div class="desc">
                                    <p>
                                       At Ontrack Energy Systems, we're here to support your journey towards uninterrupted power and efficiency. Whether you need expert advice, product information, or service assistance, we're just a message away. Let's collaborate for a reliable and empowered tomorrow.
                                ...
                                <div class="contact-map">
                                    <!-- <iframe
                                        ...
                                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7612.889908485776!2d78.37400864197039!3d17.438404783829736!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb93bd18410b0f%3A0x8d7e3fea891858ce!2sT-Hub!5e0!3m2!1sen!2sin!4v1726065753334!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="tj-contact-form">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-input">
                                        <input type="email" id="emailTwo" name="name" placeholder="Your Email Id"
                                            required="">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-input">
                                        <input type="text" id="phone" name="name" placeholder="Your Contact Number" required="">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-input">
                                        <input type="text" id="phone" name="name" placeholder="Your Company Name" required="">
                                    </div>
                                </div>
